/*
 *  WaveRenderer is a generalization of WaveView (https://github.com/gelitenight/WaveView) that
 *  will render waves on any canvas (not just in Views).
 *
 *  Copyright (C) 2016, Steve Novack for the WaveRenderer adaptation
 *
 *  Copyright (C) 2015, gelitenight(gelitenight@gmail.com). Original WaveView class.
 *
...
public class WaveRenderer {
    ...
    public int getHeight() {
        return currentBounds == null ? 0 : currentBounds.height();
    }

    public int getWidth() {
        return currentBounds == null ? 0 : currentBounds.width();
    }
    ...
    Invalidate canvasOwner;
    Rect currentBounds;

    public WaveRenderer(Invalidate canvasOwner) {
     ...
     */
    private void ensureShaderAndBounds(Rect bounds) {

        if (mWaveShader != null && bounds.equals(currentBounds)) {
            return;
        }
